...
>
    <LotusMark
        size={180}
        className="-mb-4 transition-all duration-700 hover:scale-[1.03]"
        alt="Artham"
    />

    <div
        className="font-devanagari text-arabian -mt-4 mb-1"
        style={{
    ...
    <div
        className="font-headline uppercase tracking-[0.45em] text-arabian"
        style={{
    ...
    <p className="mt-5 max-w-md font-headline italic text-arabian/80 text-sm md:text-base leading-relaxed">
